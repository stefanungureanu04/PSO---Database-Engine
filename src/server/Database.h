...
private:
    ...
    std::string handleUpdate(std::string cmd, std::string &currentDB);
    std::string handleDelete(std::string cmd, std::string &currentDB);
    ...
    std::string dropTable(std::string cmd, std::string &currentDB);
